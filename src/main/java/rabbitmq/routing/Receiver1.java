...
public class Receiver1 {
    ...
    private static final String[] ROUTING_KEYS = new String[]{"info", "error", "warn"};
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("receiver1 queueName:" + queueName);
            ...
            DeliverCallback deliverCallback = (consumerTag, delivery) -> {
                ...
                System.out.println("receiver1:" + message + " routingKey:" + delivery.getEnvelope().getRoutingKey());
            };
